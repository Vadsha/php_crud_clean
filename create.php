...
<body>
     <div class="w-full mt-8 flex justify-center">
          <form action="store.php" method="POST" class="bg-gray-200 w-1/2 flex flex-col rounded-xl">
               <h1 class="text-3xl text-center text-green-500 p-6">Create Student</h1>
               ...
               <button  class=" px-3 py-1 m-2 mr-6 font-bold text-white bg-gray-500 rounded right-4 top-10 hover:bg-green-500">create</button>
               </div>
